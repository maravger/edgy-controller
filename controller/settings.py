...
ALLOWED_HOSTS = ['10.11.17.10', '127.0.0.1', 'localhost', '192.168.0.2', '0.0.0.0']
GLOBAL_SETTINGS = {
    'API_URL': '',
    'SAMPLING_INTERVAL': 30.0,
    'U_PES_MIN': [[0, 0.125, 0.25, 0.375, 0.50], [0, 0.125, 0.25, 0.375, 0.50]],
    'U_PES_MAX': [[0, 0.125, 0.25, 0.375, 0.50], [0, 0.125, 0.25, 0.375, 0.50]],
    ...
    'U_PES_REF': [[0, 0.125, 0.25, 0.375, 0.5], [0, 0.125, 0.25, 0.375, 0.50]],
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'edgy.db'),
    }
}
